  ...
  const projects = [
    {
      ...
      description:
        "Car rental landing page, built with HTML, CSS, JS, and Bootstrap 5",
      imgUrl: projectD,
      projUrl: "https://eerfunn.github.io/binarcarrental-slicing",
    },
    {
    ...
    },
    {
      title: "Cafein",
      description:
        "Coffee shop company profile, built with CodeIgniter, and Bootstrap 4",
      imgUrl: projectE,
      ...
      <Container>
        <Row>
          <Col>
            ...
            <Tab.Container
              id="project-tabs text-align-center"
            ...
            >
              ...
              <Tab.Content>
                ...
                <Tab.Pane eventKey="second">This is page 2.</Tab.Pane>
                <Tab.Pane eventKey="third">This is page 3.</Tab.Pane>
              </Tab.Content>
            </Tab.Container>
          </Col>
        </Row>
